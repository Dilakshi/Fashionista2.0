...
var iconList = ["icon1","icon2","icon3","icon4","icon5","icon6"];
...
"The first, which will be shoppable on December 8, sees four iconic adidas silhouettes (Stan Smith, Samba Rose, Falcon and Gazelle) re-designed in a purple colour-palette, as a tribute to the Elizabeth tube line which is set to open next year and will be coloured on the map, yup you guessed it, purple.","images/wesminster.png","false"] ;
    ...
    "Zombie also cites Queen as an indelible early influence. \"The first real music that I loved as a kid and I got into music really young, I was listening to stuff in kindergarten, it was Alice Cooper, Elton John, Kiss, Queen, those were all acts that I really loved when I was little,\" he told me. \"You get a couple of songs every once in a while, you get 'Stairway To Heaven,' 'Bohemian Rhapsody' and 'Free Bird,' and you’re like, 'Here it is, one of those songs.'”","images/linkingpark.jpg","false"] ;
    ...
    "When asked about who's most likely to make her laugh among the three Khans, she named Salman Khan, the one who gives the maximum retakes, she took Aamir Khan's name and when asked about the one Khan whom she was intimidated by, Katrina said it was Shah Rukh Khan.","images/srk.png","false"] ;
...
function displayList() {
    ...
    $(document).ready(function () {
        for (let i = 0; i < newsList.length; i++) {
            $(idArr[i]).append('<div role="main" class="ui-content">' +
                '<h3>' + newsList[i][0] + '</h3>' +
                ...
                ' <div align="center">' +
                '<div is="grid" class="ui-grid-a" ><div is="block" class="ui-block-a"><a href="#map1" data-transition="flow" class="ui-btn"><h3>Find the location below</h3><img style="width: 80%" class="img-container" src="images/map1.png"></a></div><div style="padding-top: 10%"  is="block" class="ui-block-b" > <textarea  is="textarea-input" placeholder="send us your view.."  ></textarea><a href="'+msgPopupList[i]+'" data-rel="popup" class="ui-btn " data-transition="pop" is="button" onclick="addPoints('+i+')"  class="ui-btn">send</a><a href="https://www.facebook.com/" onclick=""><img src="images/fb.png"></a><a href="https://twitter.com/" onclick=""><img src="images/twitter.png"></a><a href="https://www.linkedin.com/" onclick=""><img src="images/linkedin.png"></a></div><h2 is="gk-text" id="'+scoreArrList[i]+'"></h2></div>' +
                '</div>' +
...
function displayFavList() {
    ...
    $(document).ready(function () {
        for (let i = 0; i < newsList.length; i++) {
            $(favIdArr[i]).append('<div role="main" class="ui-content">' +
                '<h3>' + newsList[i][0] + '</h3>' +
                ...
                ' </div>' +
                ' <div align="center">' +
                '<div is="grid" class="ui-grid-a" ><div is="block" class="ui-block-a"><a href="#map1"  data-transition="flow" class="ui-btn"><h3>Find the location below</h3><img class="img-container" style="width: 80%" src="images/map1.png"></a></div><div style="padding-top: 10%"  is="block" class="ui-block-b" > <textarea  is="textarea-input" placeholder="send us your view.."></textarea><a href="'+fmsgPopupList[i]+'" data-rel="popup" class="ui-btn " data-transition="pop" is="button" onclick="addPoints('+i+')"  class="ui-btn">send</a><a href="https://www.facebook.com/"  onclick="" ><img src="images/fb.png"></a><a href="https://twitter.com/"  onclick="" ><img src="images/twitter.png"></a><a href="https://www.linkedin.com/"  onclick=""><img src="images/linkedin.png"></a></div><h2 is="gk-text" id="'+scoreFevArrList[i]+'"></h2></div>' +
                '</div>' +
                '<div data-role="footer">' +
                '<h4>fashionista</h4>' +
                '</div>' +
    ...
    for (let i = 0; i < iconList.length; i++) {
        document.getElementById(iconList[i]).style.visibility = "hidden";
    }
    });
}
displayFavList();
...
function addFavIcon(num) {

    document.getElementById(iconList[num]).style.visibility  = "visible";
}
function removeFavIcon(num) {

    document.getElementById(iconList[num]).style.visibility = "hidden";
}
